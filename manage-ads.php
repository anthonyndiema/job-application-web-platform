...
if($manage_ads->is_logged_in()=="")
{
	$manage_ads->redirect('login.php');
}
 $person=$_SESSION['userSession']; $curremail=$person;
if(isset($_POST["del-job-btn"])){
    $adid_s=$_POST["adid_s"];
     $stmt = $manage_ads->runQuery("DELETE FROM advert WHERE adid=:adid");
$stmt->execute(array(":adid"=>$adid_s));
$manage_ads->redirect("manage-ads.php");
}
...
<html lang="en">
  <head>
    ...
    <meta name="description" content="manage your adverts">
      ...
      <div class="container">
        <div class="row">
          ...
          <div class="col-sm-9 page-content">
            <div class="inner-box">
              <h2 class="title-2">All Adverts</h2>
              <div class="table-responsive">
                 <?Php
require "configure.php";           // All database details will be included here 

$page_name="manage-ads.php"; //If you use this code with a different page ( or file ) name then change this 
$start=$_GET['start'];
...
$nume = $dbo->query("select count(adid) from advert where useremail='".$person."'")->fetchColumn();
...
$query=" select * from advert  where useremail='".$person."'  limit $eu, $limit ";
...
?>                         
                <table class="table table-striped table-bordered add-manage-table">
                  ...
                  <tbody>
                   ...
                   if($nume==0)
                   {
                       echo '<tr><td colspan="7" style="color:red;"><center>You have not yet posted an advert</center></td></tr>';
                       echo '<tr><td colspan="7" style="color:red;"><center><a href="post-advert.php" class="btn btn-common">POST JOB</a></center></td></tr>';
                   }
                   else{
