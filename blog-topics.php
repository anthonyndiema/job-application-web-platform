...
echo " <!-- Start Post -->
            <div class='blog-post' itemid='http://www.idawn.co.ke/".$link.$row['blogurl']."' itemscope itemtype='http://schema.org/LiveBlogPosting'>
            <div itemprop='about' itemscope itemtype='http://schema.org/Event'>
            <time itemprop='startDate' datetime='2018-06-07T10:00:00-07:00'/>
            <meta itemprop='name' content='".$row['blogtitle']."' />
            </div>
              <!-- Post thumb -->
              <div class='post-thumb'>
                <a href='#'><img itemprop='image' src='../blogimages/".$row['blogimage']."' alt='' height='300' width='800'></a>
              ...
              <!-- Post Content -->
              <div class='post-content' itemprop='liveBlogUpdate' itemscope itemtype='http://schema.org/BlogPosting'>                     
                <h4 class='post-title' itemprop='headline'><a itemprop='sameAs' href='".$link.$row['blogurl']."'>".$row['blogtitle']."</a></h4>
                <div class='meta'>
                  <span class='meta-part' itemprop='creator'><a href='#'><i class='fa fa-user'></i> ".$row['blogauthor']."</a></span>
                  <span class='meta-part' itemprop='datePublished'><a href='#'><i class='fa fa-clock-o'></i> ".(new DateTime($row['blogdate']))->format('j F Y')."</a></span>
                  <!--<span class='meta-part'><a href='#'><i class='fa fa-comment'></i> Comments 0</a></span>-->                  
                </div>
                <p itemprop='description'>".$row['blogdesc']."…</p>
                <a itemprop='sameAs' href='../".$row['blogurl']."' class='btn btn-common btn-rm'>Read More</a>
              </div>
              <!-- Post Content -->
            </div>
            <!-- End Post -->";
