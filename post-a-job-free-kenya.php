...
if($adcat=="Other"){
$adcat=trim($_POST['otheradcategory']);
}
               ...
               <?php if(isset($msg)) echo $msg;  ?></div>
                <form class="form-ad" method="post">
                    <div class="form-group">
                        ...
                        <select name="adcategory" id="adcategory" class="form-control" required="required">
                  ...
                  <div class="form-group" id="otheradcategorydiv"><input type="text" class="form-control" id="otheradcategory" name="otheradcategory" placeholder="Please type job category" /></div>
                    </div>
               <div class="form-group">
...
$("#otheradcategorydiv").hide();
$("#adcategory").change(function(){
var cat=$("#adcategory").val();
if(cat=="Other"){
$("#otheradcategorydiv").show();
}
else{
$("#otheradcategorydiv").hide();
}
