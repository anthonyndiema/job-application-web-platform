...
<html lang="en">
  <head>
    ...
    <meta name="description" content="idawn - applications received">
   <title>idawn - applications received</title>
...
$(document).ready(function() {
        var jobid=$("#jobidd").val();var jobcat=$("#jobcat").val();
	$("#results").load( "pagination/fetch_pages_applications?jobid="+jobid+"&jobcat="+jobcat); //load initial records
	$("#results").on( "click", ".pagination a", function (e){
		e.preventDefault();
		$(".loading-div").show(); //show loading element
		var page = $(this).attr("data-page"); //get page number from link
		$("#results").load("pagination/fetch_pages_applications?jobid="+jobid+"&jobcat="+jobcat,{"page":page}, function(){ //get content from PHP page
              ...
              <div class="inner-box">
                ...
                <div class="user-panel-sidebar">
                  ...
                  <h5>Ads Statistics</h5>
                       ...
                       <?php
                                                    $con=mysqli_connect('localhost','root','','jobboard');
                                                    if(!$con){
