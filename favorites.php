...
$favorite_ads = new USER();
           // All database details will be included here 
if($favorite_ads->is_logged_in()=="")
{
	$favorite_ads->redirect('login.php');
}
 $person=$_SESSION['userSession'];$curremail=$person;
if(isset($_POST["del-job-btn"])){
    $adid_s=$_POST["adid_s"];
     $stmt = $favorite_ads->runQuery("DELETE FROM advert WHERE adid=:adid");
$stmt->execute(array(":adid"=>$adid_s));
$favorite_ads->redirect("favorites.php");
}
...
<html lang="en">
  <head>
    ...
    <meta name="description" content="favorite jobs">
      ...
      <div class="container">
        <div class="row">
          ...
          <div class="col-sm-9 page-content">
            <div class="inner-box">
              <h2 class="title-2">Favorite Adverts</h2>
...
$nume = $dbo->query("select count(adid) from advert where useremail='".$person."' and isfavorite='yes'")->fetchColumn();
...
$query=" select * from advert  where useremail='".$person."'  and isfavorite='yes'  limit $eu, $limit ";
...
?>                         
                <table class="table table-striped table-bordered add-manage-table">
                  ...
                  <tbody>
                   ...
                   if($nume==0)
                   {
                       echo '<tr><td colspan="7" style="color:red;"><center>You have no favorite jobs</center></td></tr>';
                   }
                   else{
