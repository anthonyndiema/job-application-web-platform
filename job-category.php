...
<html lang="en">
  <head>
    ...
    <meta name="description" content="<?php echo $_GET['jcat'];?> jobs,internships and volunteer programs in kenya and beyond">
   <title><?php echo $_GET['jcat'];?> jobs,internships and volunteer programs in kenya and beyond</title>
          ...
          <div class="col-sm-9 page-content">
            ...
            <div class="product-filter">
              ...
              <div class="short-name">
                  <h4><?php echo $_GET['jcat'];?> jobs,internships and volunteer programs in kenya and beyond</h4>
...
<input type="hidden" id="jcateg" value="<?php echo str_replace(' ','-',$jobcategory);?>"/>
...
$page_name="../../jobs/".$jobcategory; //If you use this code with a different page ( or file ) name then change this 
$start=$_GET['start'];
...
$nume = $dbo->query("select count(adid) from advert where adcategory='".str_replace('-',' ',$jobcategory)."' and status='active'")->fetchColumn();
...
$query=" select * from advert  where adcategory='".str_replace('-',' ',$jobcategory)."' and status='active' order by dtpostd desc  limit $eu, $limit ";
