        ...
        <div class="row">
           ...
           <div class="col-sm-9 page-content">
            ...
            <div class="product-filter">
              ...
              <div class="short-name"><h4>All jobs,volunteer and internship programs in Kenya and beyond</h4></div>
...
$page_name="../jobs"; //If you use this code with a different page ( or file ) name then change this 
$start=$_GET['start'];
...
$nume = $dbo->query("select count(adid) from advert where status='active'")->fetchColumn();
...
$query=" select * from advert  where status='active' order by dtpostd desc  limit $eu, $limit ";
                  ...
                  <div class="categories-list">
                       ...
                       <?php
                          $con=mysqli_connect('localhost','idawncok_root','1993Ndiema1993','idawncok_jobboard');
                                                    ...
                                                    $sql = "SELECT * FROM advert where jobtype='Volunteer' and status='active'";
                                                    $sql2 = "SELECT * FROM advert where jobtype='Internship' and status='active'";
                                                    $sql3 = "SELECT * FROM advert where jobtype='Job' and status='active'";
                                                    ...
                                                    if($result=mysqli_query($con,$sql)){
                                                        ...
                                                        ?>
                          <table class="table table-bordered table-hover">
                              <tr><td><a href="../jobs/type/Volunteer/0">Volunteer Programs</a></td><td><?php echo $count; ?></td></tr>
                          <tr><td><a href="../jobs/type/Internship/0">Internship Programs</a></td><td><?php echo $count2; ?></td></tr>
                              <tr><td><a href="../jobs/type/Job/0">Paid Jobs</a></td><td><?php echo $count3; ?></td></tr>
                          </table>
